...
public class LoanProcess{
	...
	public void dedupe(IGetInfo customer)
	{
		...
		boolean isneg=false;
		ArrayList<Customer> negative = customer.getNegCustomer();
		int negativescore=0;
	...
	public void Scoring(IGetInfo customer)
	{
		...
		int points=0;
		if(customer.getLinfo().getIncm_score()>=100000)
		{
			System.out.println("You get 100 points on income score");
			points=points+100;
		}
		else if(customer.getLinfo().getIncm_score()<80000&& customer.getLinfo().getIncm_score()>40000)
		{
			System.out.println("you get 50 points for income score");
			points=points+50;
		}
		else if(customer.getLinfo().getIncm_score()>10000)
		{
